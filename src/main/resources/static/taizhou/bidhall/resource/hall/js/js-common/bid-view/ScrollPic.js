...
function ScrollPic(scrollContId,arrLeftId,arrRightId,dotListId){
    ...
    this.initialize=function(){
     ...
     this.leftMouseDown = function () {
        ...
        if(this.scrollContDiv.scrollLeft+this.space<this.listDiv01.scrollWidth-3*this.pageWidth) {
            _state = "floating";
    ...
    this.move=function(num,quick){
        ...
        var temp=this.scrollContDiv.scrollLeft+thisMove;if(thisMove>0) {
            if(this.scrollContDiv.scrollLeft+thisMove>=this.listDiv01.scrollWidth){this.scrollContDiv.scrollLeft=this.scrollContDiv.scrollLeft+thisMove-this.listDiv01.scrollWidth
            }
